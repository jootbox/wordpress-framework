...
class Optionspages {
	...
	public function showAdminNotice() {
		...
		<div class="notice notice-info">
			<p><?php echo __( 'Remember that settings saved on this page apply only to currently selected language. Change it using switch on top bar to configure settings for other languages.', 'wpf' ); ?></p>
		</div>
		<?php
	}
